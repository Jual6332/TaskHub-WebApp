      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo "$avgTasks";?> Average</h3>
      ...
      <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Employee Enrollment</h3>
              <br>
              <?php echo "<h4><strong>Your employment key: $user_key</strong></h4>" ?>
                
                  <form action="" method="post">
                    <fieldset class="form-group">
                      <input type="text" name="empkey" class="form-control" id="exampleInputEmail1" placeholder="Enter employment key here">
                      <br>
                       <button name="enter_empkey">Submit Request</button>
                    </fieldset>
                  </form>
                  <?php
                  include("emp_req.php")
                  ?>
                <form>
                  <?php echo "<br><h4><strong>Employment requests: </strong></h4>"?>
                  <?php
                      ...
                      if($user_req_array_len == 0){
                        ...
                        echo "<input type='checkbox' name='userCheck_req[]' value=$requester_id> $requester_name<br><br>";
      ...
      <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h2 class="box-title">Current Employees</h2>
                <br>
                <h4><strong>Below are your current employees:</strong></h4>
                <div class="box-body">
                <ul class="todo-list">
                  <?php
                  ...
                  for($i=0;$i < $countEmps || $i < $countBos;$i++){
                    if($i<count($emp_array)){
                      ...
                      <span class="text"><?php echo"$currEmpName"?></span>
                      <style type="text/css">padding-left: 0px</style>
                      </li>
                      <?php 
                      } else{
                      ?>
                        <h3>You have no active employees.</h3>
                      <?php
                        }
                      }
                      ?>
